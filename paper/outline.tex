...
\begin{enumerate}
  ...
  \begin{enumerate}[{Phase} 1.]
    ...
    \item \textit{BFS tactic search.} 25 uniquely solved (8 tree structure + 17 fallback) minus 3 $k=256$-unique $=$ 22 net. Note: algorithm is plain BFS, not true MCTS (no UCB/rollouts); ``MCTS'' used loosely following field convention. Verifier bugs inflated early runs to 58.6\%.
...
\subsection{BFS Tactic Search (called ``MCTS'' loosely)}
\begin{itemize}
